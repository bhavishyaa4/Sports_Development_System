...
<div class="header">
    ...
    <div id="navbar">
        <ul>
            <li><a href="<?php echo BASE_URL; ?>/dex.php">Home</a></li>
            <li><a href="<?php echo BASE_URL; ?>sa.php">Sports Academy</a></li>
            <li><a href="<?php echo BASE_URL; ?>apply.php">Apply</a></li>
            <li><a href="<?php echo BASE_URL; ?>allaboutus.php">About Us</a></li>
